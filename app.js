    ...
    createApp({
      setup() {
        ...
        const appsScriptUrl = ref(localStorage.getItem('homeaura_apps_script_url') || 'https://script.google.com/macros/s/AKfycbzfm2zfRIZpmRHfwfCa6G3JgCWk2dH6GEP_bXozSggC70jUjNKqG1gJEkDhw9zLkbd8xw/exec');
...
When opening index.html on your computer, all media will be resolved from these local folders.`
        ...
        const saveOrderLogs = () => {
          localStorage.setItem('homeaura_orderLogs', JSON.stringify(orderLogs.value));
        };
